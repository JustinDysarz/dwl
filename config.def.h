...
static const char *const autostart[] = {
    "sh", "-c", "~/.config/dwl.sh", NULL, NULL /* terminate */
};
...
static const Key keys[] = {
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_w, spawn, {.v = browser}},
    {MODKEY, XKB_KEY_w, spawn, {.v = grim}},
    ...
    {0,
     ...
     spawn,
     {.v = (char *[]){"pactl", "--", "set-sink-volume", "0", "-10%", NULL}}},
    {0,
    ...
    {0,
     ...
     spawn,
     {.v = (char *[]){"pactl", "--", "set-sink-mute", "0", "toggle", NULL}}},
    {0,
     XKB_KEY_XF86AudioMicMute,
     spawn,
     {.v = (char *[]){"pactl", "--", "set-source-mute", "0", "toggle", NULL}}},
    {0,
     XKB_KEY_XF86MonBrightnessDown,
     spawn,
     {.v = (char *[]){"brightnessctl", "s", "10%-", NULL}}},
    {0,
